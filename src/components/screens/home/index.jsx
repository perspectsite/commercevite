...
const Home = ({ product_categories_json }) => {
  ...
  useEffect(() => {
    // Set the page title
    document.title = "This is a site built and served using Perspect";
    ...
    setMetaTag('meta[property="og:title"]', 'content', "This is a site built and served using Perspect");
    ...
    setMetaTag('meta[name="twitter:title"]', 'content', "This is a site built and served using Perspect");
        ...
        <section className="">
          <div className="container mx-auto product-cards mt-10 mb-20 pb-8">
            <div className="text-center py-3">
              <h3 className="text-4xl font-bold mb-8 relative main-h">OUR PRODUCTS</h3>
            </div>

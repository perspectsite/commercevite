...
const AllProducts = ({ product_categories_json }) => {
  ...
  useEffect(() => {
    // Set the page title
    document.title = "This is the products page of a site built and served using Perspect";
    ...
    setMetaTag('meta[property="og:title"]', 'content', "This is the products page of a site built and served using Perspect");
    ...
    setMetaTag('meta[name="twitter:title"]', 'content', "This is the products page of a site built and served using Perspect");

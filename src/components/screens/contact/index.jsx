...
export default function Contact() {
  ...
  useEffect(() => {
    // Set the page title
    document.title = "This is the contact page of a site built and served using Perspect";
    ...
    setMetaTag('meta[property="og:title"]', 'content', "This is the contact page of a site built and served using Perspect");
    ...
    setMetaTag('meta[name="twitter:title"]', 'content', "This is the contact page of a site built and served using Perspect");
